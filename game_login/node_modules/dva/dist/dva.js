(function (global, factory) {
	...
	var _resolvePathname_2_2_0_resolvePathname = /*#__PURE__*/Object.freeze({
	...
	var _valueEqual_0_4_0_valueEqual = /*#__PURE__*/Object.freeze({
		default: valueEqual
	});
	...
	var _resolvePathname = ( _resolvePathname_2_2_0_resolvePathname && resolvePathname ) || _resolvePathname_2_2_0_resolvePathname;

	var _valueEqual = ( _valueEqual_0_4_0_valueEqual && valueEqual ) || _valueEqual_0_4_0_valueEqual;
	...
	*/
	...
	var _propTypes_15_6_1_propTypes = createCommonjsModule(function (module) {
	/**
	 * Copyright (c) 2013-present, Facebook, Inc.
	 *
	 * This source code is licensed under the MIT license found in the
	...
	Router.propTypes = {
	  history: _propTypes_15_6_1_propTypes.object.isRequired,
	  children: _propTypes_15_6_1_propTypes.node
	};
	Router.contextTypes = {
	  router: _propTypes_15_6_1_propTypes.object
	};
	Router.childContextTypes = {
	  router: _propTypes_15_6_1_propTypes.object.isRequired
	};
	...
	MemoryRouter.propTypes = {
	  initialEntries: _propTypes_15_6_1_propTypes.array,
	  initialIndex: _propTypes_15_6_1_propTypes.number,
	  getUserConfirmation: _propTypes_15_6_1_propTypes.func,
	  keyLength: _propTypes_15_6_1_propTypes.number,
	  children: _propTypes_15_6_1_propTypes.node
	};
	...
	Prompt.propTypes = {
	  when: _propTypes_15_6_1_propTypes.bool,
	  message: _propTypes_15_6_1_propTypes.oneOfType([_propTypes_15_6_1_propTypes.func, _propTypes_15_6_1_propTypes.string]).isRequired
	};
	Prompt.defaultProps = {
	  when: true
	};
	Prompt.contextTypes = {
	  router: _propTypes_15_6_1_propTypes.shape({
	    history: _propTypes_15_6_1_propTypes.shape({
	      block: _propTypes_15_6_1_propTypes.func.isRequired
	    }).isRequired
	  }).isRequired
	};
	...
	Redirect.propTypes = {
	  push: _propTypes_15_6_1_propTypes.bool,
	  from: _propTypes_15_6_1_propTypes.string,
	  to: _propTypes_15_6_1_propTypes.oneOfType([_propTypes_15_6_1_propTypes.string, _propTypes_15_6_1_propTypes.object]).isRequired
	};
	...
	Redirect.contextTypes = {
	  router: _propTypes_15_6_1_propTypes.shape({
	    history: _propTypes_15_6_1_propTypes.shape({
	      push: _propTypes_15_6_1_propTypes.func.isRequired,
	      replace: _propTypes_15_6_1_propTypes.func.isRequired
	    }).isRequired,
	    staticContext: _propTypes_15_6_1_propTypes.object
	  }).isRequired
	};
	...
	var compilePath = function compilePath(pattern, options) {
	  ...
	  var keys = [];
	  var re = _pathToRegexp_1_7_0_pathToRegexp(pattern, keys, options);
	...
	Route.propTypes = {
	  computedMatch: _propTypes_15_6_1_propTypes.object, // private, from <Switch>
	  path: _propTypes_15_6_1_propTypes.string,
	  exact: _propTypes_15_6_1_propTypes.bool,
	  strict: _propTypes_15_6_1_propTypes.bool,
	  sensitive: _propTypes_15_6_1_propTypes.bool,
	  component: _propTypes_15_6_1_propTypes.func,
	  render: _propTypes_15_6_1_propTypes.func,
	  children: _propTypes_15_6_1_propTypes.oneOfType([_propTypes_15_6_1_propTypes.func, _propTypes_15_6_1_propTypes.node]),
	  location: _propTypes_15_6_1_propTypes.object
	};
	Route.contextTypes = {
	  router: _propTypes_15_6_1_propTypes.shape({
	    history: _propTypes_15_6_1_propTypes.object.isRequired,
	    route: _propTypes_15_6_1_propTypes.object.isRequired,
	    staticContext: _propTypes_15_6_1_propTypes.object
	  })
	};
	...
	StaticRouter.propTypes = {
	  basename: _propTypes_15_6_1_propTypes.string,
	  context: _propTypes_15_6_1_propTypes.object.isRequired,
	  location: _propTypes_15_6_1_propTypes.oneOfType([_propTypes_15_6_1_propTypes.string, _propTypes_15_6_1_propTypes.object])
	};
	...
	var _hoistNonReactStatics_2_5_0_hoistNonReactStatics = createCommonjsModule(function (module, exports) {
	/**
	...
	var initialState = {
	  ...
	  if (type === LOCATION_CHANGE) {
	    return _extends$8({}, state, { location: payload });
	  }
	...
	ConnectedRouter.propTypes = {
	  store: _propTypes_15_6_1_propTypes.object,
	  history: _propTypes_15_6_1_propTypes.object.isRequired,
	  children: _propTypes_15_6_1_propTypes.node,
	  isSSR: _propTypes_15_6_1_propTypes.bool
	};
	...
	var _domWalk_0_1_1_domWalk = iterativelyWalk;
	...
	DOMElement.prototype.getElementsByClassName = function _Element_getElementsByClassName(classNames) {
	    ...
	    _domWalk_0_1_1_domWalk(this, function (node) {
	        if (node.nodeType === 1) {
	...
	DOMElement.prototype.getElementsByTagName = function _Element_getElementsByTagName(tagName) {
	    ...
	    _domWalk_0_1_1_domWalk(this.childNodes, function (node) {
	...
	DOMElement.prototype.contains = function _Element_contains(element) {
	    return _domWalk_0_1_1_domWalk(this, function (node) {
	        return element === node
	    }) || false
	};
	...
	proto$1.getElementById = function getElementById(id) {
	    ...
	    var result = _domWalk_0_1_1_domWalk(this.childNodes, function (node) {
	...
	var _minDocument_2_19_0_minDocument = new document$3();
	...
	if (typeof document !== 'undefined') {
	    ...
	    if (!doccy) {
	        doccy = topLevel['__GLOBAL_DOCUMENT_CACHE@4'] = _minDocument_2_19_0_minDocument;
	    }
	}

	var document_1 = doccy;

	var subscriptionShape = _propTypes_15_6_1_propTypes.shape({
	  trySubscribe: _propTypes_15_6_1_propTypes.func.isRequired,
	  tryUnsubscribe: _propTypes_15_6_1_propTypes.func.isRequired,
	  notifyNestedSubs: _propTypes_15_6_1_propTypes.func.isRequired,
	  isSubscribed: _propTypes_15_6_1_propTypes.func.isRequired
	});

	var storeShape = _propTypes_15_6_1_propTypes.shape({
	  subscribe: _propTypes_15_6_1_propTypes.func.isRequired,
	  dispatch: _propTypes_15_6_1_propTypes.func.isRequired,
	  getState: _propTypes_15_6_1_propTypes.func.isRequired
	});
	...
	function createProvider() {
	  ...
	  Provider.propTypes = {
	    ...
	    children: _propTypes_15_6_1_propTypes.element.isRequired
	  };
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    var Connect = function (_Component) {
	      ...
	      Connect.prototype.addExtraProps = function addExtraProps(props) {
	        ...
	        var withExtras = _extends$9({}, props);
	    ...
	    return _hoistNonReactStatics_2_5_0_hoistNonReactStatics(Connect, WrappedComponent);
	  };
	}
	...
	*/
	...
	function defaultMergeProps(stateProps, dispatchProps, ownProps) {
	  return _extends$11({}, ownProps, stateProps, dispatchProps);
	}
	...
	**/
	...
	function isObjectObject(o) {
	  return _isobject_3_0_1_isobject(o) === true
	    && Object.prototype.toString.call(o) === '[object Object]';
	}

	var _isPlainObject_2_0_4_isPlainObject = function isPlainObject(o) {
	  var ctor,prot;
	...
	var _isPlainObject2 = interopRequireDefault$2(_isPlainObject_2_0_4_isPlainObject);
	...
	var _flatten_1_0_2_flatten = function flatten(list, depth) {
	...
	var _flatten = interopRequireDefault$2(_flatten_1_0_2_flatten);
	...
	var arrayWithHoles = _arrayWithoutHoles$2;
